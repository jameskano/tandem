const en = {
  ...
  discover: {
    ...
    refineProHint: 'Filters are available with Tandem Pro.',
    budget: 'Budget',
  ...
  settings: {
    ...
    exportFailed: 'Failed to export saved activities. Please try again.',
    ...
    subscribeMonthlyPrice: 'Monthly {{price}}',
    subscribeYearly: 'Yearly',
    subscribeYearlyPrice: 'Yearly {{price}}',
    ...
    preferenceUpdateFailed: 'Failed to save your preference. Please try again.',
    about: 'About',
