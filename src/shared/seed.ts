...
import { SavedActivity } from './types/saved-activities';
...
export const seedActivities: SavedActivity[] = [
  {
    ...
    tags: ['EUR 15-25', '90 min', 'home', 'foodie', 'creative', 'cozy'],
  },
  {
    id: 'activity-2',
  ...
  },
  {
    ...
    tags: ['Free', '2h', 'home', 'games', 'funny', 'cozy'],
  },
  {
    id: 'activity-4',
    title: '🏛️ Museum Afternoon',
    description:
      'Visit a museum or gallery and each choose one piece to talk about.',
    tags: ['EUR 20-40', '2h', 'city', 'culture', 'relax'],
  },
  {
    id: 'activity-5',
    title: '🧺 Forest Picnic',
    ...
    tags: ['EUR 10-20', '3h', 'nature', 'romantic', 'relax', 'cozy'],
  },
  {
    id: 'activity-6',
    ...
    tags: ['EUR 5-15', '3h', 'home', 'cozy', 'nostalgic', 'relax'],
  },
  {
    id: 'activity-7',
    ...
    tags: ['EUR 50-80', '2h', 'city', 'creative', 'surprise'],
  },
  {
    id: 'activity-8',
    title: '🏖️ Beach Morning',
    description:
      'Start early, bring coffee, and spend a calm morning by the water.',
    tags: ['EUR 10-20', 'half_day', 'outdoors', 'relax', 'romantic'],
  },
  {
    id: 'activity-9',
    ...
    tags: ['EUR 10-20', '90 min', 'city', 'creative', 'cozy'],
  },
  {
    id: 'activity-10',
    ...
    tags: ['Free', '60 min', 'home', 'games', 'funny', 'nostalgic'],
  },
  {
    id: 'activity-11',
    ...
    tags: ['EUR 5-15', '2h', 'outdoors', 'adventure', 'relax'],
  },
  {
    id: 'activity-12',
  ...
  },
  {
    ...
    tags: ['EUR 0-25', '90 min', 'city', 'culture', 'cozy'],
  },
  {
    id: 'activity-15',
    ...
    tags: ['EUR 40-80', 'full_day', 'anywhere', 'adventure', 'surprise'],
  },
  {
    id: 'activity-16',
  ...
  },
  {
    ...
    tags: ['Free', '2h', 'nature', 'romantic', 'surprise', 'relax'],
  },
  {
    id: 'activity-19',
    ...
    tags: ['EUR 10-20', '90 min', 'home', 'foodie', 'creative', 'funny'],
  },
  {
    id: 'activity-20',
    title: '🗺️ Hidden Spots Day',
    description:
      'Each person picks one underrated local spot and reveals it during the date.',
    tags: ['EUR 15-40', 'half_day', 'city', 'surprise', 'adventure', 'culture'],
  },
];
